...
def __handle_request(controller_func: Callable, *args: Any, **kwargs: Any):
...
def handler_create(controller: BaseController, request: dict) -> list:
    return __handle_request(controller.create, request)


def handler_update(controller: BaseController, request: dict) -> list:
        return __handle_request(controller.update, request)


def handler_get_by_id(controller: BaseController, id: int) -> list:
        return __handle_request(controller.get_by_id, id)


def handler_get_all(controller: BaseController) -> list:
