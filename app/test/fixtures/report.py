...
def orders_data_frame_row_mock() -> dict:
    return  {'_id': 1,
        ...
        {'beverage': {'name': 'beverage1', 'price': 15.6, '_id': 2},
            'ingredient_price': None, 'beverage_price': 12.25, 'ingredient': None},
        {'beverage': {'name': 'beverage1', 'price': 15.6, '_id': 2}, 'ingredient_price': None, 'beverage_price': 19.38, 'ingredient': None},
        {'beverage': {'name': 'beverage2', 'price': 15.6, '_id': 2},
            'ingredient_price': None, 'beverage_price': 16.04, 'ingredient': None}],
...
def orders_data_mock() -> dict:
    return  [{'_id': 1,
        ...
        {'beverage': {'name': 'bltivmhfyx', 'price': 15.6, '_id': 2},
            'ingredient_price': None, 'beverage_price': 12.25, 'ingredient': None},
        ...
        'total_price': 156.32},
        {'_id': 2,
         'client_address': 'vpqkwenjrz', 'client_dni': '2877374003', 'client_name': 'nhweotpqkz', 'client_phone': '5447470741', 'date': '2023-05-20T17:59:42.109109',
        'detail':[
        {'beverage': None, 'ingredient_price': 16.29, 'beverage_price': None, 'ingredient': {'name': 'bltivmhfyx', 'price': 15.6, '_id': 2}
        }, 
        {'beverage': None, 'ingredient_price': 15.68, 'beverage_price': None, 'ingredient': {'name': 'bltivmhfyx', 'price': 15.6, '_id': 2}
